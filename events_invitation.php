<?php
	...
	$string_query_my_events = "SELECT * FROM tbl_events INNER JOIN tbl_participation ON tbl_events.id_event = tbl_participation.id_event WHERE tbl_participation.id_user_reciver='$id_user' ORDER BY event_date DESC";
	...
	$smarty -> display('events_invitation.tpl');
	mysqli_close($connection);
?>